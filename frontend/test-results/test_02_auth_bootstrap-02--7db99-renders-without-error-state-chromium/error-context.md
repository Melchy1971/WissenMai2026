...
- Name: test_02_auth_bootstrap.spec.js >> 02 Auth bootstrap — 03 complete session >> app shell renders without error state
- Location: tests\gui_truth\test_02_auth_bootstrap.spec.js:101:7
