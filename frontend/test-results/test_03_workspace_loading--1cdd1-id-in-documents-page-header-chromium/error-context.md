...
- Name: test_03_workspace_loading.spec.js >> 03 Workspace loading >> shows active workspace id in documents page header
- Location: tests\gui_truth\test_03_workspace_loading.spec.js:4:7
