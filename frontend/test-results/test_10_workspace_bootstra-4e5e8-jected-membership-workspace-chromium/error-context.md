...
- Name: test_10_workspace_bootstrap.spec.js >> 10 Workspace bootstrap — 01 workspace from membership >> workspace id from bootstrap matches injected membership workspace
- Location: tests\gui_truth\test_10_workspace_bootstrap.spec.js:30:7
...
```yaml
- heading "Login erforderlich" [level=2]
- paragraph: Die Sitzung ist abgelaufen oder es fehlt eine Anmeldung.
- paragraph: "Fehlercode: AUTH_REQUIRED"
- paragraph: "Technischer Code: AUTH_REQUIRED"
- paragraph: "Aktion: Zur Anmeldung wechseln"
```
