...
- Name: test_07_chat.spec.js >> 07 Chat flow >> navigation from documents to chat preserves workspace context
- Location: tests\gui_truth\test_07_chat.spec.js:28:7
...
Call log:
  - waiting for getByRole('link', { name: 'Chat' })
    - locator resolved to <a class="" href="/chat" data-discover="true">Chat</a>
