...
- Name: test_02_auth_bootstrap.spec.js >> 02 Auth bootstrap — 01 no token >> no workspace error shown on login page
- Location: tests\gui_truth\test_02_auth_bootstrap.spec.js:43:7
