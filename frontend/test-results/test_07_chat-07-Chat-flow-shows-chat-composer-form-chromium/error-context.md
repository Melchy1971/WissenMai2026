...
- Name: test_07_chat.spec.js >> 07 Chat flow >> shows chat composer form
- Location: tests\gui_truth\test_07_chat.spec.js:20:7
...
Call log:
  ...
  - waiting for getByLabel('Titel der Sitzung')
