...
- Name: test_09_diagnostics.spec.js >> 09 Diagnostics GUI >> shows system status card
- Location: tests\gui_truth\test_09_diagnostics.spec.js:9:7
...
Call log:
  ...
  - waiting for getByText('Systemstatus')
