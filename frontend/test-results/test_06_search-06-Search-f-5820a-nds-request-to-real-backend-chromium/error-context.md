...
- Name: test_06_search.spec.js >> 06 Search flow >> search with workspace context sends request to real backend
- Location: tests\gui_truth\test_06_search.spec.js:23:7
...
Call log:
  - waiting for getByLabel('Suchbegriff')
    - locator resolved to <input value="" type="search" placeholder="z. B. Vertragsentwurf oder Paragraph 5"/>
    - fill("gui truth")
