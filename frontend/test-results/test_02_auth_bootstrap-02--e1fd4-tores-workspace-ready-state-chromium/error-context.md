...
- Name: test_02_auth_bootstrap.spec.js >> 02 Auth bootstrap — 08 logout >> after logout, a fresh login restores workspace ready state
- Location: tests\gui_truth\test_02_auth_bootstrap.spec.js:363:7
