...
- Name: test_09_diagnostics.spec.js >> 09 Diagnostics GUI >> shows database status card
- Location: tests\gui_truth\test_09_diagnostics.spec.js:18:7
...
Call log:
  ...
  - waiting for getByText('DB Status')
