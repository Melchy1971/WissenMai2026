...
- `reports/archive/legacy/20260605T100000Z/frontend_full_suite_staged_report.json` ist Pflichtartefakt fuer produktionsnahe GUI-Aussagen.
...
2. Frontend Truth Reports sind Pflichtartefakte; ohne aktuellen `reports/archive/legacy/20260605T100000Z/frontend_full_suite_staged_report.json` bleibt der Status `unknown`, `partial` oder `fail`.
...
- `reports/archive/legacy/20260605T100000Z/frontend_full_suite_staged_report.json` ist aktuell, maschinenlesbar und weist `passed = collected`, `failed = 0`, `skipped = 0` und `exit_code = 0` aus
...
1. `reports/archive/legacy/20260605T100000Z/frontend_full_suite_staged_report.json` ist Pflichtartefakt fuer GUI-Readiness und Regression-Bewertung.
